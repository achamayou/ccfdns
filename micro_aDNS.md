...
multi-zone extension in the addendum.
...
## Addendum: Merkle-authenticated multi-zone aDNS
...
This addendum defines an application-specific extension. It is not DNSSEC. An
...
Thus, this mechanism is an optional addendum to the single-zone design.
